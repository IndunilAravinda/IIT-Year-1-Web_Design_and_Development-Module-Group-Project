// create an array to store data that we need to get
const productList = [
   {
      id: 101001,
...
function clickHandler1() {
   //pass the personal Infromations to variables from html document
   ...
   //check if user forget to enter user Name or user Email
   if (userFirstName === "") {
   ...
   //pass personal Informations to the variables called personal Information Lables from html document
   ...
   //pass product Informatios to the variables from html document
   const productNumber = document.getElementById("productNumber").value;
   const productQuantity = document.getElementById("productQuantity").value;

   //check if user forget to enter product numbre or product quantity
   if (productNumber === "") {
   ...
   //create a funtion to access product list items
...
//creat a funtion to Purchase
function clickHandler2() {
   alert("Thanks for Purchase");
}
//call the funtion and pass it in to Event Listener
